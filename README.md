...
首先推荐这本游戏开发入门书籍，理论和实践都有，讲解了2D和3D游戏的知识，用的SDL和OpenGL程序库。
```
...
这个程序可以看成是一个命令台游戏引擎，在Github上，你只需要点击上面的`Use Template`，就可以拷贝到自己的存储库，在此基础上编写自己的版本


我自己也编写了一些例子，会不定时进行更新
...
这模板主要是提供一个控制台游戏程序应该有的框架结构，和一些基础输入输出功能。
